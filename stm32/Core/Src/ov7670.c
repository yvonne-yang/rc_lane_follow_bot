...
uint8_t ov7670_init(void){
  ...
  // Your code here
	...
	print_msg("ov7670 init finished");
  //
...
uint8_t ov7670_read(uint8_t reg){
  // Your code here
	...
	if(HAL_I2C_Master_Receive(&hi2c2, ADDR_OV7670, &val, 1, 100) != HAL_OK)
		Error_Handler();
	return val;
  // 
}
...
HAL_StatusTypeDef ov7670_write(uint8_t reg,uint8_t val){
  // Your code here
	return HAL_I2C_Mem_Write(&hi2c2, ADDR_OV7670, reg, I2C_MEMADD_SIZE_8BIT, &val, 1, 100);
  //
}
